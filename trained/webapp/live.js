...
const LIVE_API_URL = window.APP_CONFIG.apiUrl;
...
async function startLive() {
    ...
    try {
        ...
        // io('') is not treated as same-origin by socket.io-client (only
        // io() with no argument is) - fall back to undefined when apiUrl
        // is empty so it connects to the page's own origin.
        socket = io(LIVE_API_URL || undefined, { transports: ['websocket', 'polling'] });
